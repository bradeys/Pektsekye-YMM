( function ($) {
  ...
  $.widget("pektsekye.ymm", { 
    ...
    _create : function () {
      console.log('in _create 1');

      var yearElement = $(".ymm-select[name='_year']");
      console.log('yearElement is', yearElement);
      ...
      this.loadLevel(null, yearElement);
      ...
      if (option.length){
        ...
        console.log('in _create 2');
      }                           
    },
  
  
    preSelectDropdowns : function(e){
    console.log('pre select dropdowns');
    ...
    loadLevel : function(e, target){
     ...
     console.log('after disable levels');
      ...
      if (value != ''){
       ...
       console.log('value doesnt equal ""');

        var values = [];
        var selects = this.element.find('.ymm-select');
        selects.each(function() {
          values.push($(this).val());        
          console.log('i am going to return', this == element[0]);        
          if (this == element[0])
            return false;  
        });         
        ...
        if (selects.length == values.length){// last drop-down is selected 
          ...
          console.log('selects equals values');

          console.log('in loadlevel canShowExtra is', this.canShowExtra);


          //bradey added 1 and undefined
          if (this.canShowExtra == 1 || this.canShowExtra == undefined)
    ...
    hideExtra : function(){
      ...
      if(this.searchAnySelButton) this.searchAnySelButton.show(); 
    },
    ...
    _submit : function(searchWord, categoryUrl, garageValues){
      ...
      console.log('before set searchWord');
    ...
    getLevelValuesAsParams : function(){  
      console.log('getLevelValuesAsParams');

      var params = {};
      var pNames = this.levelParameterNames ?? ["_make","_model","_year"];

      console.log('this.levelParameterNames', this.levelParameterNames);
