...
<div class="ymm-selector ymm-box" id="ymm_<?php echo $this->getWidgetId(); ?>">
  ...
  <div class="block-content">
    ...
    <?php if ($this->getCategorySearchEnabled() || $this->getWordSearchEnabled()): ?>      	
      <!-- bradey originalcode=<div class="ymm-extra" <?php if (!$this->isResultsPage()): ?> style="display:none" <?php endif; ?> >-->
      <div class="ymm-extra">
...
<script>
  jQuery(function($){
    ...
    console.log('can show extra', <?php echo $this->canShowExtra(); ?>)
    ...
    $('#ymm_<?php echo $this->getWidgetId(); ?>').ymm({
      ...
      canShowExtra             : <?php echo 1 //$this->canShowExtra() ? 1 : 0; ?>,
